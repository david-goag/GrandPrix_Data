...
# --- INITIALIZATION ---
print("=============================================")
print("          Starting Points Heatmap            ")
print("=============================================")
SEASONS_LIST = os.environ["SEASONS_LIST"].split(",")
print("✅ Environment variables loaded successfully.")

def points_heatmap(season: int) -> go.Figure:
...
if __name__ == "__main__":
    ...
    points_heatmap_fig = points_heatmap(int(SEASONS_LIST[-1]))

    # Plot the updated heatmap
    show(points_heatmap_fig)
